...
import { ChevronDown, User, FileText, Bookmark, LogOut } from "lucide-react";
import { useAuth } from "../../contexts/AuthContext";

const defaultAvatar = "https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_1280.png";

export default function AccountMenu() {
    const { username, profilePicture, logoutHandler } = useAuth();
                ...
                <div className="account-menu-panel" role="menu">
                    <div className="account-menu-header">
                        ...
                        <div className="account-menu-header-text">
                            ...
                            <span className="account-menu-header-role">Member</span>
                        </div>
                    </div>
