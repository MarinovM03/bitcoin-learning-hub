...
import type { Bubble, MempoolTx, MempoolStats, RecommendedFees } from '../../utils/mempoolHelpers';
...
export default function MempoolVisualizer() {
    ...
    const addBubbles = (txs: MempoolTx[]) => {
        const canvas = canvasRef.current;
        if (!canvas) return;
        const w = canvas.width;
        ...
        <div className="page-content mempool-page">
            ...
            {hovered && (
                <div
                    ...
                    style={{ '--tip-x': tipPos.x + 'px', '--tip-y': tipPos.y + 'px' } as CSSProperties}
                >
