...
import type { SearchArticleHit, SearchGlossaryHit, SearchFilters, ReadTimeBucket } from "../../services/searchService";
...
export default function SearchPage() {
    ...
    const [results, setResults] = useState<{ articles: SearchArticleHit[]; glossary: SearchGlossaryHit[] }>({ articles: [], glossary: [] });
    ...
    useEffect(() => {
        ...
        if (activeReadTime !== 'All') filters.readTime = activeReadTime as ReadTimeBucket;
    ...
    const activeFilters = useMemo(() => {
        ...
        if (activeReadTime !== 'All') chips.push({ key: 'readTime', label: 'Read time', value: READ_TIME_LABELS[activeReadTime as keyof typeof READ_TIME_LABELS] || activeReadTime });
        return chips;
