...
export const createArticleSchema = z.object({
    ...
    category: z.enum(CATEGORIES, { message: 'Choose a category from the list' }),
    difficulty: z.enum(DIFFICULTIES, { message: 'Choose a difficulty level' }).optional(),
    imageUrl: httpUrl,
